...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="relative flex flex-col-reverse gap-10 items-start justify-between px-8 pt-20 text-left md:flex-row md:px-36 md:pt-32 min-h-screen">
        {/* background */}
        <div className="absolute top-0 left-0 w-full h-[500px] bg-gradient-to-b from-cyan-100/70 -z-10" />
        ...
        <div className="max-w-xl z-10 text-gray-500">
         ...
         <p className="text-sm">Course by <span className="text-blue-600 underline">LMS EduVibe</span></p>
        ...
        {/* right Column */}
        <div className="max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t-lg md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
             ...
             <button className="md:mt-6 mt-4 cursor-pointer w-full py-3 rounded bg-blue-600 text-white font-medium">{isAlreadyEnrolled ? "Already Enrolled" : "Enroll Now"}</button>
